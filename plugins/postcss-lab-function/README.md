...
> "color(display-p3 -0.01656 0.23079 0.25298)" is out of gamut for "display-p3". When "preserve: true" is set this will lead to unexpected results in some browsers.
