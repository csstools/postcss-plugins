...
<script src="https://unpkg.com/css-prefers-color-scheme@8.0.0/dist/browser-global.js"></script>
<script>prefersColorSchemeInit()</script>
```

⚠️ Please use a versioned url, like this : `https://unpkg.com/css-prefers-color-scheme@8.0.0/dist/browser-global.js`
