...
export type pluginOptions = {
	...
	import: {
		 ...
		 */
		plugins: Array<any>, // eslint-disable-line @typescript-eslint/no-explicit-any
		 ...
		 */
		resolve: (id: string, basedir: string, importOptions: any) => string | Array<string> | Promise<string | Array<string>>, // eslint-disable-line @typescript-eslint/no-explicit-any

		/**
		 * You can overwrite the default loading way by setting this option.
		 * This function gets (filename, importOptions) arguments and returns content or promised content.
		 */
		load: (filename: string, importOptions: any) => string | Promise<string>, // eslint-disable-line @typescript-eslint/no-explicit-any
...
const creator: PluginCreator<pluginOptions> = (opts?: pluginOptions) => {
	const postcssImportOptions = Object.assign({
