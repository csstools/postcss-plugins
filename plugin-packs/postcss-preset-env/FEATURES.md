...
| `nesting-rules` | Nesting Rules (_not compatible with `postcss-nested`_) | [example](https://preset-env.cssdb.org/features/#nesting-rules) | [docs](https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-nesting#readme) |
