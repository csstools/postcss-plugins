...
import type { pluginOptions as pluginOptions_10 } from '@csstools/postcss-color-mix-function';
import type { pluginOptions as pluginOptions_11 } from '@csstools/postcss-color-mix-variadic-function-arguments';
import type { pluginOptions as pluginOptions_12 } from '@csstools/postcss-content-alt-text';
import type { pluginOptions as pluginOptions_13 } from 'postcss-custom-media';
import type { pluginOptions as pluginOptions_14 } from 'postcss-custom-properties';
import type { pluginOptions as pluginOptions_15 } from 'postcss-custom-selectors';
import type { pluginOptions as pluginOptions_16 } from 'postcss-dir-pseudo-class';
import type { pluginOptions as pluginOptions_17 } from '@csstools/postcss-normalize-display-values';
import type { pluginOptions as pluginOptions_18 } from 'postcss-double-position-gradients';
import type { pluginOptions as pluginOptions_19 } from '@csstools/postcss-exponential-functions';
import type { pluginOptions as pluginOptions_2 } from '@csstools/postcss-initial';
import type { pluginOptions as pluginOptions_20 } from '@csstools/postcss-logical-float-and-clear';
import type { pluginOptions as pluginOptions_21 } from 'postcss-focus-visible';
import type { pluginOptions as pluginOptions_22 } from 'postcss-focus-within';
import type { pluginOptions as pluginOptions_23 } from '@csstools/postcss-font-format-keywords';
...
import type { pluginOptions as pluginOptions_34 } from '@csstools/postcss-light-dark-function';
import type { pluginOptions as pluginOptions_35 } from '@csstools/postcss-logical-overflow';
import type { pluginOptions as pluginOptions_36 } from '@csstools/postcss-logical-overscroll-behavior';
import type { pluginOptions as pluginOptions_37 } from 'postcss-logical';
import type { pluginOptions as pluginOptions_38 } from '@csstools/postcss-logical-resize';
import type { pluginOptions as pluginOptions_39 } from '@csstools/postcss-logical-viewport-units';
import type { pluginOptions as pluginOptions_4 } from 'css-blank-pseudo';
import type { pluginOptions as pluginOptions_40 } from '@csstools/postcss-media-queries-aspect-ratio-number-values';
import type { pluginOptions as pluginOptions_41 } from '@csstools/postcss-media-minmax';
import type { pluginOptions as pluginOptions_42 } from '@csstools/postcss-nested-calc';
import type { pluginOptions as pluginOptions_43 } from 'postcss-nesting';
import type { pluginOptions as pluginOptions_44 } from 'postcss-selector-not';
import type { pluginOptions as pluginOptions_45 } from '@csstools/postcss-oklab-function';
import type { pluginOptions as pluginOptions_46 } from 'postcss-overflow-shorthand';
import type { pluginOptions as pluginOptions_47 } from 'postcss-place';
import type { pluginOptions as pluginOptions_48 } from 'css-prefers-color-scheme';
import type { pluginOptions as pluginOptions_49 } from '@csstools/postcss-random-function';
...
import type { pluginOptions as pluginOptions_53 } from '@csstools/postcss-sign-functions';
import type { pluginOptions as pluginOptions_54 } from '@csstools/postcss-stepped-value-functions';
...
import type { pluginOptions as pluginOptions_8 } from '@csstools/postcss-color-function-display-p3-linear';
import type { pluginOptions as pluginOptions_9 } from 'postcss-color-functional-notation';
...
export declare type pluginsOptions = {
    ...
    'color-function-display-p3-linear'?: subPluginOptions<pluginOptions_8>;
    /** plugin options for "postcss-color-functional-notation" */
    'color-functional-notation'?: subPluginOptions<pluginOptions_9>;
    /** plugin options for "@csstools/postcss-color-mix-function" */
    'color-mix'?: subPluginOptions<pluginOptions_10>;
    /** plugin options for "@csstools/postcss-color-mix-variadic-function-arguments" */
    'color-mix-variadic-function-arguments'?: subPluginOptions<pluginOptions_11>;
    /** plugin options for "@csstools/postcss-content-alt-text" */
    'content-alt-text'?: subPluginOptions<pluginOptions_12>;
    /** plugin options for "postcss-custom-media" */
    'custom-media-queries'?: subPluginOptions<pluginOptions_13>;
    /** plugin options for "postcss-custom-properties" */
    'custom-properties'?: subPluginOptions<pluginOptions_14>;
    /** plugin options for "postcss-custom-selectors" */
    'custom-selectors'?: subPluginOptions<pluginOptions_15>;
    /** plugin options for "postcss-dir-pseudo-class" */
    'dir-pseudo-class'?: subPluginOptions<pluginOptions_16>;
    /** plugin options for "@csstools/postcss-normalize-display-values" */
    'display-two-values'?: subPluginOptions<pluginOptions_17>;
    /** plugin options for "postcss-double-position-gradients" */
    'double-position-gradients'?: subPluginOptions<pluginOptions_18>;
    /** plugin options for "@csstools/postcss-exponential-functions" */
    'exponential-functions'?: subPluginOptions<pluginOptions_19>;
    /** plugin options for "@csstools/postcss-logical-float-and-clear" */
    'float-clear-logical-values'?: subPluginOptions<pluginOptions_20>;
    /** plugin options for "postcss-focus-visible" */
    'focus-visible-pseudo-class'?: subPluginOptions<pluginOptions_21>;
    /** plugin options for "postcss-focus-within" */
    'focus-within-pseudo-class'?: subPluginOptions<pluginOptions_22>;
    /** plugin options for "@csstools/postcss-font-format-keywords" */
    'font-format-keywords'?: subPluginOptions<pluginOptions_23>;
    ...
    'gamut-mapping'?: subPluginOptions<pluginOptions_24>;
    /** plugin options for "postcss-gap-properties" */
    'gap-properties'?: subPluginOptions<pluginOptions_25>;
    /** plugin options for "@csstools/postcss-gradients-interpolation-method" */
    'gradients-interpolation-method'?: subPluginOptions<pluginOptions_26>;
    /** plugin options for "css-has-pseudo" */
    'has-pseudo-class'?: subPluginOptions<pluginOptions_27>;
    /** plugin options for "postcss-color-hex-alpha" */
    'hexadecimal-alpha-notation'?: subPluginOptions<pluginOptions_28>;
    /** plugin options for "@csstools/postcss-hwb-function" */
    'hwb-function'?: subPluginOptions<pluginOptions_29>;
    /** plugin options for "@csstools/postcss-ic-unit" */
    'ic-unit'?: subPluginOptions<pluginOptions_30>;
    /** plugin options for "postcss-image-set-function" */
    'image-set-function'?: subPluginOptions<pluginOptions_31>;
    /** plugin options for "@csstools/postcss-is-pseudo-class" */
    'is-pseudo-class'?: subPluginOptions<pluginOptions_32>;
    /** plugin options for "postcss-lab-function" */
    'lab-function'?: subPluginOptions<pluginOptions_33>;
    /** plugin options for "@csstools/postcss-light-dark-function" */
    'light-dark-function'?: subPluginOptions<pluginOptions_34>;
    /** plugin options for "@csstools/postcss-logical-overflow" */
    'logical-overflow'?: subPluginOptions<pluginOptions_35>;
    /** plugin options for "@csstools/postcss-logical-overscroll-behavior" */
    'logical-overscroll-behavior'?: subPluginOptions<pluginOptions_36>;
    /** plugin options for "postcss-logical" */
    'logical-properties-and-values'?: subPluginOptions<pluginOptions_37>;
    /** plugin options for "@csstools/postcss-logical-resize" */
    'logical-resize'?: subPluginOptions<pluginOptions_38>;
    /** plugin options for "@csstools/postcss-logical-viewport-units" */
    'logical-viewport-units'?: subPluginOptions<pluginOptions_39>;
    /** plugin options for "@csstools/postcss-media-queries-aspect-ratio-number-values" */
    'media-queries-aspect-ratio-number-values'?: subPluginOptions<pluginOptions_40>;
    /** plugin options for "@csstools/postcss-media-minmax" */
    'media-query-ranges'?: subPluginOptions<pluginOptions_41>;
    /** plugin options for "@csstools/postcss-nested-calc" */
    'nested-calc'?: subPluginOptions<pluginOptions_42>;
    /** plugin options for "postcss-nesting" */
    'nesting-rules'?: subPluginOptions<pluginOptions_43>;
    /** plugin options for "postcss-selector-not" */
    'not-pseudo-class'?: subPluginOptions<pluginOptions_44>;
    /** plugin options for "@csstools/postcss-oklab-function" */
    'oklab-function'?: subPluginOptions<pluginOptions_45>;
    ...
    'overflow-property'?: subPluginOptions<pluginOptions_46>;
    ...
    'place-properties'?: subPluginOptions<pluginOptions_47>;
    /** plugin options for "css-prefers-color-scheme" */
    'prefers-color-scheme-query'?: subPluginOptions<pluginOptions_48>;
    /** plugin options for "@csstools/postcss-random-function" */
    'random-function'?: subPluginOptions<pluginOptions_49>;
    /** plugin options for "postcss-color-rebeccapurple" */
    'rebeccapurple-color'?: subPluginOptions<pluginOptions_50>;
    /** plugin options for "@csstools/postcss-relative-color-syntax" */
    'relative-color-syntax'?: subPluginOptions<pluginOptions_51>;
    /** plugin options for "@csstools/postcss-scope-pseudo-class" */
    'scope-pseudo-class'?: subPluginOptions<pluginOptions_52>;
    /** plugin options for "@csstools/postcss-sign-functions" */
    'sign-functions'?: subPluginOptions<pluginOptions_53>;
    /** plugin options for "@csstools/postcss-stepped-value-functions" */
    'stepped-value-functions'?: subPluginOptions<pluginOptions_54>;
    ...
    'text-decoration-shorthand'?: subPluginOptions<pluginOptions_55>;
    /** plugin options for "@csstools/postcss-trigonometric-functions" */
    'trigonometric-functions'?: subPluginOptions<pluginOptions_56>;
    /** plugin options for "@csstools/postcss-unset-value" */
    'unset-value'?: subPluginOptions<pluginOptions_57>;
};
