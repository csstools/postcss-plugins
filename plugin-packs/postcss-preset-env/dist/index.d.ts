...
import type { pluginOptions as pluginOptions_13 } from '@csstools/postcss-container-rule-prelude-list';
import type { pluginOptions as pluginOptions_14 } from '@csstools/postcss-content-alt-text';
import type { pluginOptions as pluginOptions_15 } from '@csstools/postcss-contrast-color-function';
import type { pluginOptions as pluginOptions_16 } from 'postcss-custom-media';
import type { pluginOptions as pluginOptions_17 } from 'postcss-custom-properties';
import type { pluginOptions as pluginOptions_18 } from 'postcss-custom-selectors';
import type { pluginOptions as pluginOptions_19 } from 'postcss-dir-pseudo-class';
...
export declare type pluginsOptions = {
    ...
    'container-rule-prelude-list'?: subPluginOptions<pluginOptions_13>;
    /** plugin options for "@csstools/postcss-content-alt-text" */
    'content-alt-text'?: subPluginOptions<pluginOptions_14>;
    /** plugin options for "@csstools/postcss-contrast-color-function" */
    'contrast-color-function'?: subPluginOptions<pluginOptions_15>;
    /** plugin options for "postcss-custom-media" */
    'custom-media-queries'?: subPluginOptions<pluginOptions_16>;
    /** plugin options for "postcss-custom-properties" */
    'custom-properties'?: subPluginOptions<pluginOptions_17>;
    /** plugin options for "postcss-custom-selectors" */
    'custom-selectors'?: subPluginOptions<pluginOptions_18>;
    /** plugin options for "postcss-dir-pseudo-class" */
    'dir-pseudo-class'?: subPluginOptions<pluginOptions_19>;
    /** plugin options for "@csstools/postcss-normalize-display-values" */
    'display-two-values'?: subPluginOptions<pluginOptions_20>;
