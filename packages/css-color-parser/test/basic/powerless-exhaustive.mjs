...

{
	const tests = [
		...
		['color-mix(in hsl, hsl(180 0 50%), hsl(11 33 44))', 'color(srgb 0.4557825 0.54755 0.39245)', 'hsl(95.5 16.5% 47%)'],
		['color-mix(in hsl, hsl(180 50% 0), hsl(11 33 44))', 'color(srgb 0.20326167 0.3113 0.1287)', 'hsl(95.5 41.5% 22%)'],
		['color-mix(in hsl, hsl(0 0 50%), hsl(11 33 44))', 'color(srgb 0.54755 0.4066675 0.39245)', 'hsl(5.5 16.5% 47%)'],
		['color-mix(in hsl, hsl(180 0 0), hsl(11 33 44))', 'color(srgb 0.213345 0.2563 0.1837)', 'hsl(95.5 16.5% 22%)'],
		['color-mix(in hsl, hsl(0 50% 0), hsl(11 33 44))', 'color(srgb 0.3113 0.14543833 0.1287)', 'hsl(5.5 41.5% 22%)'],
		['color-mix(in hsl, hsl(0 0 0), hsl(11 33 44))', 'color(srgb 0.2563 0.190355 0.1837)', 'hsl(5.5 16.5% 22%)'],

		['color-mix(in hsl, hsl(180 0.001% 50%), hsl(11 33 44))', 'color(srgb 0.45578207 0.54755235 0.39244765)', 'hsl(95.5 16.5005% 47%)'],
		...
		['color-mix(in hwb, hwb(180 100% 25%), hwb(11 33 44))', 'color(srgb 0.65841584 0.65841584 0.65841584)', 'hwb(95.5 66.5% 34.5%)'],
		['color-mix(in hwb, hwb(180 25% 100%), hwb(11 33 44))', 'color(srgb 0.28712871 0.28712871 0.28712871)', 'hwb(95.5 29% 72%)'],
		['color-mix(in hwb, hwb(0 100% 25%), hwb(11 33 44))', 'color(srgb 0.65841584 0.65841584 0.65841584)', 'hwb(5.5 66.5% 34.5%)'],
		['color-mix(in hwb, hwb(180 100% 100%), hwb(11 33 44))', 'color(srgb 0.4801444 0.4801444 0.4801444)', 'hwb(95.5 66.5% 72%)'],
		['color-mix(in hwb, hwb(0 25% 100%), hwb(11 33 44))', 'color(srgb 0.28712871 0.28712871 0.28712871)', 'hwb(5.5 29% 72%)'],
		['color-mix(in hwb, hwb(0 100% 100%), hwb(11 33 44))', 'color(srgb 0.4801444 0.4801444 0.4801444)', 'hwb(5.5 66.5% 72%)'],

		['color-mix(in hwb, hwb(180 99.999% 0%), hwb(11 33 44))', 'color(srgb 0.71195538 0.78 0.664995)', 'hwb(95.5 66.4995% 22%)'],
		['color-mix(in hwb, hwb(180 99.999% none), hwb(11 33 44))', 'color(srgb 0.60180815 0.60180815 0.60180815)', 'hwb(95.5 66.4995% 44%)'],
		...
		['color-mix(in hwb, hwb(180 0% 99.999%), hwb(11 33 44))', 'color(srgb 0.21196037 0.280005 0.165)', 'hwb(95.5 16.5% 71.9995%)'],
		['color-mix(in hwb, hwb(180 none 99.999%), hwb(11 33 44))', 'color(srgb 0.31428721 0.31428721 0.31428721)', 'hwb(95.5 33% 71.9995%)'],
		...
		['color-mix(in hwb, hwb(180 49.999% 50%), hwb(11 33 44))', 'color(srgb 0.46195538 0.53 0.414995)', 'hwb(95.5 41.4995% 47%)'],
		...
		['color-mix(in lch, lch(20 0 180), lch(11 33 44))', 'lch(15.5 16.5 112)'],
		['color-mix(in lch, lch(20 20 0), lch(11 33 44))', 'lch(15.5 26.5 22)'],
		['color-mix(in lch, lch(0 0 180), lch(11 33 44))', 'lch(5.5 16.5 112)'],
		['color-mix(in lch, lch(20 0 0), lch(11 33 44))', 'lch(15.5 16.5 22)'],
		['color-mix(in lch, lch(0 20 0), lch(11 33 44))', 'lch(5.5 26.5 22)'],
		['color-mix(in lch, lch(0 0 0), lch(11 33 44))', 'lch(5.5 16.5 22)'],

		['color-mix(in lch, lch(20 0.0015 180), lch(11 33 44))', 'lch(15.5 16.50075 112)'],
		...
		['color-mix(in oklch, hsl(0 50% 50%))', 'oklch(0.55233858 0.16366995 24.21253898)'],
		['color-mix(in oklch, hsl(180 0 50%))', 'oklch(0.59818073 0 none)'],
		['color-mix(in oklch, hsl(180 50% 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, hsl(0 0 50%))', 'oklch(0.59818073 0 none)'],
		['color-mix(in oklch, hsl(180 0 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, hsl(0 50% 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, hsl(0 0 0))', 'oklch(0 0 none)'],

		['color-mix(in oklch, hsl(180 0.001% 50%))', 'oklch(0.59818073 0 none)'],
		['color-mix(in oklch, hsl(180 0.0011% 50%))', 'oklch(0.59818306 0 none)'],

		['color-mix(in oklch, hwb(0 25% 25%))', 'oklch(0.55233858 0.16366995 24.21253898)'],
		['color-mix(in oklch, hwb(180 100% 25%))', 'oklch(0.84522226 0 none)'],
		['color-mix(in oklch, hwb(180 25% 100%))', 'oklch(0.32109251 0 none)'],
		['color-mix(in oklch, hwb(0 100% 25%))', 'oklch(0.84522226 0 none)'],
		['color-mix(in oklch, hwb(180 100% 100%))', 'oklch(0.59818073 0 none)'],
		['color-mix(in oklch, hwb(0 25% 100%))', 'oklch(0.32109251 0 none)'],
		['color-mix(in oklch, hwb(0 100% 100%))', 'oklch(0.59818073 0 none)'],

		['color-mix(in oklch, hwb(180 99.999% 0%))', 'oklch(0.99999242 0 none)'],
		['color-mix(in oklch, hwb(180 99.998% 0%))', 'oklch(0.99999614 0.00000541 197.15830446)'],

		['color-mix(in oklch, lch(0 20 180))', 'oklch(-0.05666101 0.26412556 175.27132911)'],
		['color-mix(in oklch, lch(20 0 180))', 'oklch(0.31034483 0 none)'],
		['color-mix(in oklch, lch(20 20 0))', 'oklch(0.31697196 0.06085528 359.39300302)'],
		['color-mix(in oklch, lch(0 0 180))', 'oklch(0 0 none)'],
		['color-mix(in oklch, lch(20 0 0))', 'oklch(0.31034483 0 none)'],
		['color-mix(in oklch, lch(0 20 0))', 'oklch(0.05666101 0.26412556 355.27132911)'],
		['color-mix(in oklch, lch(0 0 0))', 'oklch(0 0 none)'],

		['color-mix(in oklch, lch(20 0.0015 180))', 'oklch(0.31034483 0 none)'],
		['color-mix(in oklch, lch(20 0.00151 180))', 'oklch(0.31034434 0.00000446 179.50900432)'],

		['color-mix(in oklch, oklch(0 0.2 180))', 'oklch(0 0.2 180)'],
		['color-mix(in oklch, oklch(0.2 0 180))', 'oklch(0.2 0 180)'],
		['color-mix(in oklch, oklch(0.2 0.2 0))', 'oklch(0.2 0.2 0)'],
		['color-mix(in oklch, oklch(0 0 180))', 'oklch(0 0 180)'],
		['color-mix(in oklch, oklch(0.2 0 0))', 'oklch(0.2 0 0)'],
		['color-mix(in oklch, oklch(0 0.2 0))', 'oklch(0 0.2 0)'],
		['color-mix(in oklch, oklch(0 0 0))', 'oklch(0 0 0)'],

		['color-mix(in oklch, oklch(0.2 0.000004 180))', 'oklch(0.2 0.000004 180)'],
		['color-mix(in oklch, oklch(0.2 0.0000041 180))', 'oklch(0.2 0.0000041 180)'],

		['color-mix(in oklch, rgb(0 0 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, color(display-p3 0 0 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, lab(0 0 0))', 'oklch(0 0 none)'],
		['color-mix(in oklch, oklab(0 0 0))', 'oklch(0 0 none)'],

		['color-mix(in oklch, color(display-p3 0.08610937692934956 0.08610188202042188 0.08610387292083356))', 'oklch(0.2 0.000004 359.99999992)'],
		['color-mix(in oklch, color(display-p3 0.0860989 0.08610658 0.08610454))', 'oklch(0.2 0.0000041 179.99967542)'],
	];
