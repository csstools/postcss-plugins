...
[
	...
	['color(from color(display-p3 0 1 0) srgb r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) srgb r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) srgb r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) srgb r g b)', 'rgb(0, 242, 114)'],
	...
	['color(from color(display-p3 0 1 0) srgb-linear r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) srgb-linear r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) srgb-linear r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) srgb-linear r g b)', 'rgb(0, 242, 114)'],

	['color(from color(srgb 0 1 0) display-p3 r g b)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 0) display-p3 r g b)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 0) display-p3 r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) display-p3 r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) display-p3 r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) display-p3 r g b)', 'rgb(0, 242, 114)'],

	['color(from color(srgb 0 1 0) a98-rgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 0) a98-rgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 0) a98-rgb r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) a98-rgb r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) a98-rgb r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) a98-rgb r g b)', 'rgb(0, 242, 114)'],
	...
	['color(from color(display-p3 0 1 0) prophoto-rgb r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) prophoto-rgb r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) prophoto-rgb r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) prophoto-rgb r g b)', 'rgb(0, 242, 114)'],

	['color(from color(srgb 0 1 0) rec2020 r g b)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 0) rec2020 r g b)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 0) rec2020 r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) rec2020 r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 0) rec2020 r g b)', 'rgb(0, 245, 117)'],
	['color(from color(rec2020 0 1 0) rec2020 r g b)', 'rgb(0, 242, 114)'],

	// None : 1
	['color(from color(srgb 0 1 none) srgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 none) srgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 none) srgb r g b)', 'rgb(0, 252, 86)'],
	['color(from color(a98-rgb 0 1 none) srgb r g b)', 'rgb(0, 236, 115)'],
	['color(from color(prophoto-rgb 0 1 none) srgb r g b)', 'rgb(0, 246, 145)'],
	['color(from color(rec2020 0 1 none) srgb r g b)', 'rgb(0, 242, 134)'],
	...
	['color(from color(display-p3 0 1 none) srgb-linear r g b)', 'rgb(0, 252, 86)'],
	['color(from color(a98-rgb 0 1 none) srgb-linear r g b)', 'rgb(0, 236, 115)'],
	['color(from color(prophoto-rgb 0 1 none) srgb-linear r g b)', 'rgb(0, 246, 145)'],
	['color(from color(rec2020 0 1 none) srgb-linear r g b)', 'rgb(0, 242, 134)'],

	['color(from color(srgb 0 1 none) display-p3 r g b)', 'rgb(53, 253, 0)'],
	['color(from color(srgb-linear 0 1 none) display-p3 r g b)', 'rgb(53, 253, 0)'],
	['color(from color(display-p3 0 1 none) display-p3 r g b)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 none) display-p3 r g b)', 'rgb(0, 236, 95)'],
	['color(from color(prophoto-rgb 0 1 none) display-p3 r g b)', 'rgb(0, 246, 131)'],
	['color(from color(rec2020 0 1 none) display-p3 r g b)', 'rgb(0, 242, 119)'],

	['color(from color(srgb 0 1 none) a98-rgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 none) a98-rgb r g b)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 none) a98-rgb r g b)', 'rgb(0, 251, 65)'],
	['color(from color(a98-rgb 0 1 none) a98-rgb r g b)', 'rgb(0, 236, 104)'],
	['color(from color(prophoto-rgb 0 1 none) a98-rgb r g b)', 'rgb(0, 246, 136)'],
	['color(from color(rec2020 0 1 none) a98-rgb r g b)', 'rgb(0, 242, 125)'],

	// None : 2
	['color(from color(srgb 0 1 0) srgb r g none)', 'rgb(0, 255, 0)'],
	['color(from color(srgb-linear 0 1 0) srgb r g none)', 'rgb(0, 255, 0)'],
	['color(from color(display-p3 0 1 0) srgb r g none)', 'rgb(0, 252, 86)'],
	['color(from color(a98-rgb 0 1 0) srgb r g none)', 'rgb(0, 236, 115)'],
	['color(from color(prophoto-rgb 0 1 0) srgb r g none)', 'rgb(0, 246, 145)'],
	['color(from color(rec2020 0 1 0) srgb r g none)', 'rgb(0, 242, 134)'],
	...
	['color(from color(display-p3 0 1 0) srgb-linear r g none)', 'rgb(0, 252, 86)'],
	['color(from color(a98-rgb 0 1 0) srgb-linear r g none)', 'rgb(0, 236, 115)'],
	['color(from color(prophoto-rgb 0 1 0) srgb-linear r g none)', 'rgb(0, 246, 145)'],
	['color(from color(rec2020 0 1 0) srgb-linear r g none)', 'rgb(0, 242, 134)'],

	['color(from color(srgb 0 1 0) display-p3 r g none)', 'rgb(53, 253, 0)'],
	['color(from color(srgb-linear 0 1 0) display-p3 r g none)', 'rgb(53, 253, 0)'],
	['color(from color(display-p3 0 1 0) display-p3 r g none)', 'rgb(0, 251, 41)'],
	['color(from color(a98-rgb 0 1 0) display-p3 r g none)', 'rgb(0, 236, 95)'],
	['color(from color(prophoto-rgb 0 1 0) display-p3 r g none)', 'rgb(0, 246, 131)'],
	['color(from color(rec2020 0 1 0) display-p3 r g none)', 'rgb(0, 242, 119)'],
