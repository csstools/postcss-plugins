...
const tests = [
	...
	['lab(50 -160 160)', 'rgb(0, 130, 45)', 'color(display-p3 0 0.52847 0.08233)'],
	['lab(50 -200 200)', 'rgb(62, 125, 0)', 'color(display-p3 0.28208 0.49443 0)'],
	...
	['oklab(0.5 -1.6 1.6)', 'rgb(58, 116, 0)', 'color(display-p3 0.2645 0.45811 0)'],
	['oklab(0.5 -2 2)', 'rgb(58, 116, 0)', 'color(display-p3 0.26451 0.45811 0)'],
	...
	['oklab(0.5 -0.2 0)', 'rgb(0, 116, 101)', 'color(display-p3 0 0.46434 0.40122)'],
	...
	['lab(20 -62.5 112.5 / 0.5)', 'rgba(37, 49, 0, 0.5)', 'color(display-p3 0.15111 0.19218 0 / 0.5)'],
	['lab(20% -50% 90%/0.5)', 'rgba(37, 49, 0, 0.5)', 'color(display-p3 0.15111 0.19218 0 / 0.5)'],
	['oklab(0.2 0.28 -0.32 / 0.5)', 'rgba(36, 0, 54, 0.5)', 'color(display-p3 0.12904 0 0.20956 / 0.5)'],
	['oklab(20% 70% -80%/0.5)', 'rgba(36, 0, 54, 0.5)', 'color(display-p3 0.12904 0 0.20956 / 0.5)'],
	...
	['lch(20 50 20deg/0.5)', 'rgba(102, 0, 30, 0.5)', 'color(display-p3 0.38092 0.00312 0.11269 / 0.5)'],
	['lch(20 50 20deg/50%)', 'rgba(102, 0, 30, 0.5)', 'color(display-p3 0.38092 0.00312 0.11269 / 0.5)'],
	...
	['lch(10 20 1.28rad)', 'rgb(37, 26, 0)', 'color(display-p3 0.14104 0.10116 0)'],
	...
	['oklch(0.2 0.5 20deg/0.5)', 'rgba(50, 0, 6, 0.5)', 'color(display-p3 0.1852 0 0.0211 / 0.5)'],
	['oklch(0.2 0.5 20deg/50%)', 'rgba(50, 0, 6, 0.5)', 'color(display-p3 0.1852 0 0.0211 / 0.5)'],
	['oklch(0.1 0.2 20deg / -10%)', 'rgba(13, 0, 1, 0)', 'color(display-p3 0.04599 0 0.00264 / 0)'],
	['oklch(0.1 0.2 20deg / 110%)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	['oklch(0.1 0.2 1.28rad)', 'rgb(6, 3, 0)', 'color(display-p3 0.02397 0.01009 0)'],
	['oklch(0.1 0.2 380deg)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	['oklch(0.1 0.2 -340deg)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	['oklch(0.1 0.2 740deg)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	['oklch(0.1 0.2 -700deg)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	...
	['oklch(0.1 0.2 20 / 110%)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	['oklch(0.1 0.2 -700)', 'rgb(13, 0, 1)', 'color(display-p3 0.04599 0 0.00264)'],
	...
	['lch(20 120 10 / 0.5)', 'rgba(112, 0, 49, 0.5)', 'color(display-p3 0.41882 0 0.18762 / 0.5)'],
	['lch(20% 80% 10/0.5)', 'rgba(112, 0, 49, 0.5)', 'color(display-p3 0.41882 0 0.18762 / 0.5)'],
	['oklch(0.2 0.24 10 / 0.5)', 'rgba(49, 0, 14, 0.5)', 'color(display-p3 0.18193 0 0.05031 / 0.5)'],
	['oklch(20% 60% 10/0.5)', 'rgba(49, 0, 14, 0.5)', 'color(display-p3 0.18193 0 0.05031 / 0.5)'],
];
