...
const tests = [
	...
	['oklab(0.5 -0.4 0.4)', 'rgb(48, 118, 0)', 'color(display-p3 0.24084 0.46589 0)'],
	['oklab(0.5 -1 1)', 'rgb(48, 118, 0)', 'color(display-p3 0.24094 0.46586 0)'],
	...
	['oklab(calc(0.50 / 3) calc(0.5 - 1) calc(1.5) / calc(-0.5 + 1))', 'rgba(17, 16, 0, 0.5)', 'color(display-p3 0.06796 0.06171 0 / 0.5)'],
