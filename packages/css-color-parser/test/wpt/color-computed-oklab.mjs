...
const tests = [
	...
	['oklab(0.2 0 0.1/0.5)', 'rgba(29, 21, 0, 0.5)', 'color(display-p3 0.11287 0.08198 0 / 0.5)'],
	['oklab(0.2 0 0.1/50%)', 'rgba(29, 21, 0, 0.5)', 'color(display-p3 0.11287 0.08198 0 / 0.5)'],
	['oklab(4 0 0.1/50%)', 'rgba(255, 255, 255, 0.5)', 'color(display-p3 1 1 1 / 0.5)'],
	['oklab(0.5 -0.4 0.4)', 'rgb(58, 116, 0)', 'color(display-p3 0.26444 0.45812 0)'],
	['oklab(0.5 -1 1)', 'rgb(58, 116, 0)', 'color(display-p3 0.26447 0.45811 0)'],
	...
	['oklab(calc(0.50 / 3) calc(0.5 - 1) calc(1.5) / calc(-0.5 + 1))', 'rgba(16, 16, 0, 0.5)', 'color(display-p3 0.06415 0.06174 0 / 0.5)'],
