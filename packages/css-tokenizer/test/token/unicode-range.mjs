...
// Sanity check without the additional flag
{
	...
	assert.deepEqual(
		...
		[
			...
			['number-token', '+4E00', 7, 11, { value: 4, type: 'number' }],
			[
				'dimension-token',
				'-9FFF',
				12,
				16,
				{ value: -9, type: 'integer', unit: 'FFF' },
			],
			['comma-token', ',', 17, 17, undefined],
			['whitespace-token', ' ', 18, 18, undefined],
			['ident-token', 'U', 19, 19, { value: 'U' }],
			['number-token', '+30', 20, 22, { value: 30, type: 'integer' }],
...

{
	...
	assert.deepEqual(
		...
		[
			...
			['number-token', '1', 15, 15, { value: 1, type: 'integer' }],
		],
	);
}

{
	...
	assert.deepEqual(
		...
		[
			...
			['number-token', '1', 8, 8, { value: 1, type: 'integer' }],
			[
				'number-token',
				'-0000011',
				9,
