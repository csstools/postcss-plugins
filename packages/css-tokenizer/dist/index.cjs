...
function consumeComment(ctx, reader) {
  ...
  return [exports.TokenType.Comment, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
}
...
function consumeHashToken(ctx, reader) {
  ...
  if (reader.codePointSource[reader.cursor] !== undefined && isIdentCodePoint(reader.codePointSource[reader.cursor]) || checkIfTwoCodePointsAreAValidEscape(ctx, reader)) {
    ...
    return [exports.TokenType.Hash, reader.representationString(), reader.representationStart, reader.representationEnd, {
      value: String.fromCharCode(...identSequence),
      type: hashType
    }];
  }
  return [exports.TokenType.Delim, reader.representationString(), reader.representationStart, reader.representationEnd, {
    value: '#'
  }];
}
...
function consumeNumericToken(ctx, reader) {
  ...
  if (checkIfThreeCodePointsWouldStartAnIdentSequence(ctx, reader)) {
    ...
    return [exports.TokenType.Dimension, reader.representationString(), reader.representationStart, reader.representationEnd, {
      value: numberValue[0],
      type: numberValue[1],
  ...
  }
  {
    if (reader.codePointSource[reader.cursor] === PERCENTAGE_SIGN) {
      reader.advanceCodePoint();
      return [exports.TokenType.Percentage, reader.representationString(), reader.representationStart, reader.representationEnd, {
        value: numberValue[0]
      }];
    }
  }
  return [exports.TokenType.Number, reader.representationString(), reader.representationStart, reader.representationEnd, {
    value: numberValue[0],
    type: numberValue[1]
  }];
}
...
function consumeWhiteSpace(ctx, reader) {
  ...
  return [exports.TokenType.Whitespace, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
}
...
function consumeStringToken(ctx, reader) {
  ...
  while (true) {
    ...
    if (next === false) {
      ...
      return [exports.TokenType.String, reader.representationString(), reader.representationStart, reader.representationEnd, {
        value: result
      }];
    }
    if (isNewLine(next)) {
      ...
      return [exports.TokenType.BadString, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
    }
    if (next === first) {
      return [exports.TokenType.String, reader.representationString(), reader.representationStart, reader.representationEnd, {
        value: result
...
function consumeUrlToken(ctx, reader) {
  ...
  while (true) {
    if (reader.codePointSource[reader.cursor] === undefined) {
      ...
      return [exports.TokenType.URL, reader.representationString(), reader.representationStart, reader.representationEnd, {
        value: string
      }];
    }
    if (reader.codePointSource[reader.cursor] === RIGHT_PARENTHESIS) {
    ...
    if (isWhitespace(reader.codePointSource[reader.cursor])) {
      ...
      return [exports.TokenType.BadURL, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
    }
...
function consumeIdentLikeToken(ctx, reader) {
  ...
  if (reader.codePointSource[reader.cursor] !== LEFT_PARENTHESIS) {
    return [exports.TokenType.Ident, reader.representationString(), reader.representationStart, reader.representationEnd, {
  ...
  if (checkIfCodePointsMatchURLIdent(ctx, codePoints)) {
    ...
    while (true) {
      ...
      if (firstNonWhitespace === QUOTATION_MARK || firstNonWhitespace === APOSTROPHE) {
        ...
        return [exports.TokenType.Function, reader.representationString(), reader.representationStart, reader.representationEnd, {
          value: String.fromCharCode(...codePoints)
        }];
      }
      break;
  ...
  function nextToken() {
    ...
    switch (peeked) {
      case COMMA:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.Comma, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case COLON:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.Colon, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case SEMICOLON:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.Semicolon, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case LEFT_PARENTHESIS:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.OpenParen, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case RIGHT_PARENTHESIS:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.CloseParen, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case LEFT_SQUARE_BRACKET:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.OpenSquare, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case RIGHT_SQUARE_BRACKET:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.CloseSquare, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case LEFT_CURLY_BRACKET:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.OpenCurly, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case RIGHT_CURLY_BRACKET:
        {
          reader.advanceCodePoint();
          return [exports.TokenType.CloseCurly, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
        }
      case APOSTROPHE:
      case QUOTATION_MARK:
      ...
      case HYPHEN_MINUS:
        {
          ...
          if (checkIfThreeCodePointsWouldStartCDC(ctx, reader)) {
            reader.advanceCodePoint(3);
            return [exports.TokenType.CDC, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
          }
          if (checkIfThreeCodePointsWouldStartAnIdentSequence(ctx, reader)) {
            return consumeIdentLikeToken(ctx, reader);
          }
      ...
      case LESS_THAN_SIGN:
        {
          if (checkIfFourCodePointsWouldStartCDO(ctx, reader)) {
            ...
            return [exports.TokenType.CDO, reader.representationString(), reader.representationStart, reader.representationEnd, undefined];
          }
          reader.advanceCodePoint();
          return [exports.TokenType.Delim, reader.representationString(), reader.representationStart, reader.representationEnd, {
            value: '<'
      ...
      case COMMERCIAL_AT:
        {
          ...
          if (checkIfThreeCodePointsWouldStartAnIdentSequence(ctx, reader)) {
            const identSequence = consumeIdentSequence(ctx, reader);
            return [exports.TokenType.AtKeyword, reader.representationString(), reader.representationStart, reader.representationEnd, {
              value: String.fromCharCode(...identSequence)
            }];
          }
          return [exports.TokenType.Delim, reader.representationString(), reader.representationStart, reader.representationEnd, {
