 ...
 */function sRGB_to_HSL(t){const o=t[0],_=t[1],e=t[2],n=Math.max(o,_,e),r=Math.min(o,_,e),a=(r+n)/2,i=n-r;let l=NaN,u=0;if(0!==Math.round(1e5*i)){switch(u=0===Math.round(1e5*a)||1e5===Math.round(1e5*a)?0:(n-a)/Math.min(a,1-a),n){case o:l=(_-e)/i+(_<e?6:0);break;case _:l=(e-o)/i+2;break;case e:l=(o-_)/i+4}l*=60}return u<0&&(l+=180,u=Math.abs(u)),l>=360&&(l-=360),[l,100*u,100*a]}
/**
