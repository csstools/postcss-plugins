 ...
 */function deltaEOK(t,_){const[n,o,e]=t,[r,a,i]=_,l=n-r,u=o-a,c=e-i;return Math.sqrt(l**2+u**2+c**2)}function binarySearchGamut(t,_,n){let o=0,e=t[1];const r=t;for(;e-o>1e-4;){const t=clip(_(r));deltaEOK(OKLCH_to_OKLab(r),OKLCH_to_OKLab(n(t)))-.02<1e-4?o=r[1]:e=r[1],r[1]=(e+o)/2}return clip(_([...r]))}
/**
