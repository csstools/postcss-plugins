 ...
 * - Blue as number 0..1;
 */
export function XYZ_D65_to_sRGB(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_sRGB(y);
	y = gam_sRGB(y);
	return y;
 ...
 * - Lightness as number 0..100;
 */
export function XYZ_D65_to_HSL(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_sRGB(y);
	y = gam_sRGB(y);
	y = sRGB_to_HSL(y);
 ...
 * - Blackness as number 0..100;
 */
export function XYZ_D65_to_HWB(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_sRGB(y);
 ...
 * - b as number -160..160;
 */
export function XYZ_D65_to_Lab(x: Color): Color {
	let y = x;
	y = D65_to_D50(y);
	y = XYZ_to_Lab(y);
	return y;
 ...
 * - Hue as degrees 0..360;
 */
export function XYZ_D65_to_LCH(x: Color): Color {
	let y = x;
	y = D65_to_D50(y);
	y = XYZ_to_Lab(y);
	y = Lab_to_LCH(y);
 ...
 * - b as number 0..0.5;
 */
export function XYZ_D65_to_OKLab(x: Color): Color {
	let y = x;
	y = XYZ_to_OKLab(y);
	return y;
}
 ...
 * - Hue as degrees 0..360;
 */
export function XYZ_D65_to_OKLCH(x: Color): Color {
	let y = x;
	y = XYZ_to_OKLab(y);
	y = OKLab_to_OKLCH(y);
	return y;
 ...
 * - Blue as number 0..1;
 */
export function XYZ_D65_to_lin_sRGB(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_sRGB(y);
	return y;
}
 ...
 * - Blue as number 0..1;
 */
export function XYZ_D65_to_a98_RGB(x: Color): Color {
	let y = x;
 ...
 * - B as number 0..1;
 */
export function XYZ_D65_to_P3(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_P3(y);
	y = gam_P3(y);
	return y;
 ...
 * - B as number 0..1;
 */
export function XYZ_D65_to_lin_P3(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_P3(y);
	return y;
}
 ...
 * - Blue as number 0..1;
 */
export function XYZ_D65_to_rec_2020(x: Color): Color {
	let y = x;
	y = XYZ_to_lin_2020(y);
	y = gam_2020(y);
	return y;
 ...
 * - Blue as number 0..1;
 */
export function XYZ_D65_to_ProPhoto(x: Color): Color {
	let y = x;
	y = D65_to_D50(y);
